...
<html lang="en">
	...
	<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap" rel="stylesheet">
		...
		<title>CRQ - Customer Requst System</title>
	</head>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="POST" action="{{ route('auth.authenticate') }}">
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">UserName</label>
                                                <input type="text" name="user_login" class="form-control" id="inputEmailAddress" placeholder="Username">
                                            </div>
                                            <div class="col-12">
